...
# Config: batch_size=128, device_batch_size=64, sequence_length=1024, num_iterations=20400, embed_lr=0.0036, muon_lr=0.00045, 1000-step warmup then linear decay, block_weight_decay=0.0, seed=0
import os
import random
import sys
...
class Hyperparameters:
    ...
    muon_learning_rate : float = 0.00045
