...
# Purpose: cosine MuonW wd0 full-run LR/norm match to wd0p1 reference with learnable RMSNorm gamma at B=128, T=1024, 20400 steps.
# Token budget matches the B=512, T=1024, 5100-step large-batch setup.
# Config: batch_size=128, device_batch_size=64, sequence_length=1024, num_iterations=20400, lr=0.0036, muon_lr=0.02, warmup+cosine, block_weight_decay=0.0, match wd0p1 Muon LR/norm from update 1, seed=0
import os
import random
import sys
