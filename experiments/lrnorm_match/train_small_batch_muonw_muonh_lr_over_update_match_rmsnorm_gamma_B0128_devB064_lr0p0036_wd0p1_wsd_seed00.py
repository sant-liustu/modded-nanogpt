...
# Purpose: WSD MuonW wd0p1 experiment with learnable RMSNorm gamma at B=128, T=1024, 20400 steps.
...
# Config: batch_size=128, device_batch_size=64, sequence_length=1024, num_iterations=20400, lr=0.0036, warmup+stable+warmdown, block_weight_decay=0.1, seed=0
import os
import random
import sys
