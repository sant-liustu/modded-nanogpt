# Copied from the RMSNorm gamma AdamW wd0p1 baseline.
# Purpose: drop block/tied embedding weight decay after warmup while keeping the baseline LR schedule.
# Token budget matches the B=128, T=1024, 20400-step small-batch setup.
# Config: batch_size=128, device_batch_size=64, sequence_length=1024, num_iterations=20400, lr=0.0036, weight_decay=0.1 -> 0.0 after update 1000, seed=0
import os
import random
import sys
...
class Hyperparameters:
    ...
    seed : int = 0
    weight_decay_switch_start_update : int = 1001 # first update after warmup: drop block and tied wte/lm_head WD
