# Copied from experiments/small_batch_adamw_baseline generated AdamW baseline.
# Purpose: add block weight decay after warmup and match wd0 block LR / total block norm.
...
class Hyperparameters:
    ...
    seed : int = 0
    lrnorm_reference_json : str = 'experiments/lrnorm_match/reference_wd0_rep03_block_total_lr_over_norm.jsonl'
    lrnorm_match_start_update : int = 1001 # first update after warmup: add block WD and match LR / block total norm
