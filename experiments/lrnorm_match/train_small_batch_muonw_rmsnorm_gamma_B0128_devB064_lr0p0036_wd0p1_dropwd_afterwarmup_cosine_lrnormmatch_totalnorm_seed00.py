...
# Purpose: cosine MuonW wd0p1 -> wd0 after-warmup LR/norm match with learnable RMSNorm gamma at B=128, T=1024, 20400 steps.
# Token budget matches the B=512, T=1024, 5100-step large-batch setup.
# Config: batch_size=128, device_batch_size=64, sequence_length=1024, num_iterations=20400, lr=0.0036, muon_lr=0.02, warmup+cosine, block_weight_decay=0.1 -> 0.0 after update 1000, seed=0
import os
import random
import sys
...
class Hyperparameters:
    ...
    lrnorm_match_start_update : int = 1001 # first update after warmup: drop block WD and match Muon LR / block+embedding total norm
