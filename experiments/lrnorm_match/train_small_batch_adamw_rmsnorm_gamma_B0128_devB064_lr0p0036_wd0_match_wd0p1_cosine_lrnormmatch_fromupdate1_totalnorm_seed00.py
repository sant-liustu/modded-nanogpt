...
# Purpose: full-run wd0 model matching cosine wd0p1 block LR / total block norm from update 1.
# Token budget matches the B=512, T=1024, 5100-step large-batch setup.
# Config: batch_size=128, device_batch_size=64, sequence_length=1024, num_iterations=20400, lr=0.0036, warmup+cosine, block_weight_decay=0.0 throughout, seed=0
import os
import random
import sys
