...
# Purpose: WSD MuonW wd0 reference with learnable RMSNorm gamma at B=128, T=1024, 20400 steps.
# Variant: initialize every 2D Muon block matrix with std=1/sqrt(d_in), matching the MuonH initialization.
...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # MuonH-compatible initialization for every Muon matrix:
