# Warmup matches train_small_batch_adamw_rmsnorm_gamma_B0128_devB064_lr0p0036_wd0p1_seed00.py; update 1001 switches WD 0.1 -> 0.0 and matches actual 73-mean RMS-ELR.
...
class Hyperparameters:
    ...
    seed : int = 0
    mean_elr_reference_json : str = 'experiments/wte_inclusive_mean_elr_afterwarmup/reference_wd0p1.jsonl'
    mean_elr_control_start_update : int = 1001
    mean_elr_match_log_every : int = 1
    post_warmup_weight_decay : float = 0.0
args = Hyperparameters()
assert args.mean_elr_control_start_update == args.warmup_iters + 1
...
def maybe_apply_wte_inclusive_actual_mean_elr_controller(update_step):
    ...
    target_weight_decay = args.post_warmup_weight_decay
    ...
    if should_log_mean_elr_match(update_step):
        record = dict(
            ...
            weight_decay_mode='wd0p1_to_0.0_afterwarmup',
