# Warmup matches train_small_batch_adamw_rmsnorm_gamma_B0128_devB064_lr0p0036_wd0_seed00.py; update 1001 switches WD 0.0 -> 0.1 and matches actual 73-mean RMS-ELR.
...
class Hyperparameters:
    ...
    seed : int = 0
    mean_elr_reference_json : str = 'experiments/wte_inclusive_mean_elr_afterwarmup/reference_wd0.jsonl'
    mean_elr_control_start_update : int = 1001
    mean_elr_match_log_every : int = 1
    post_warmup_weight_decay : float = 0.1
...
def maybe_apply_wte_inclusive_actual_mean_elr_controller(update_step):
    ...
    if should_log_mean_elr_match(update_step):
        record = dict(
            ...
            weight_decay_mode='wd0_to_0.1_afterwarmup',
