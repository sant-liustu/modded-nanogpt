...
class Hyperparameters:
    ...
    muon_slow_momentum : float = 0.95
    muon_slow_alpha : float = 8
    ...
    multimuon_buffer_norm_every : int = 1 # every how many optimizer steps to log MultiMuon buffers? 0 disables
