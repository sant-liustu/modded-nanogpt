...
class Hyperparameters:
    ...
    lrnorm_reference_json : str = 'experiments/eta_lambda_invariance/reference_w768_lr0p0144_wsd_wd0p1_embedding_plus_block_rms_lr_over_norm.jsonl'
...
# begin logging
if master_process:
    run_id = f'eta_lam_w512_lr0p0144_wsd_wd0p066667_lrn_w768lr0p0144_wd0p1_s{args.seed}_' + str(uuid.uuid4())
