...
class Hyperparameters:
    ...
    weight_decay : float = 0.2 # AdamW weight decay applied to tied wte/lm_head and transformer blocks
    seed : int = 0
...
# begin logging
if master_process:
    run_id = f'eta_lam_w1536_lr0p0144_cos_wd0p2_lrn_w768lr0p0144_wd0p1_s{args.seed}_' + str(uuid.uuid4())
