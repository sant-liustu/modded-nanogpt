...
class Hyperparameters:
    ...
    weight_decay : float = 0.13333333333333333 # AdamW weight decay applied to tied wte/lm_head and transformer blocks
    seed : int = 0
...
num_vocab = 50304
model = GPT(GPTConfig(vocab_size=num_vocab, n_layer=12, n_head=8, n_embd=1024))
...
# begin logging
if master_process:
    run_id = f'eta_lam_w1024_lr0p0144_cos_wd0p133333_lrn_w768lr0p0144_wd0p1_s{args.seed}_' + str(uuid.uuid4())
