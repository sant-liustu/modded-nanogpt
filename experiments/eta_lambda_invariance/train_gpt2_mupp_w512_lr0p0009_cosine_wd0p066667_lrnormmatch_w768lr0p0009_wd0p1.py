...
class GPTConfig:
    ...
    n_layer : int = 12
    n_head : int = 4 # head dim 128 suggested by @Grad62304977
    n_embd : int = 512
    init_std : float = 0.02
    scale_emb : float = 1.0
...
class Hyperparameters:
    ...
    embed_learning_rate : float = 0.0009
    ...
    weight_decay : float = 0.06666666666666667 # AdamW weight decay applied to tied wte/lm_head and transformer blocks
    seed : int = 0
    ...
    lrnorm_reference_json : str = 'experiments/eta_lambda_invariance/reference_w768_lr0p0009_cosine_wd0p1_embedding_plus_block_rms_lr_over_norm.jsonl'
...
num_vocab = 50304
model = GPT(GPTConfig(vocab_size=num_vocab, n_layer=12, n_head=4, n_embd=512))
...
# begin logging
if master_process:
    run_id = f'eta_lam_w512_lr0p0009_cos_wd0p066667_lrn_w768lr0p0009_wd0p1_s{args.seed}_' + str(uuid.uuid4())
