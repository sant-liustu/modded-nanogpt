...
hidden_weight_decay = args.weight_decay * width_multiplier
...
optimizer2 = torch.optim.AdamW(raw_model.transformer.h.parameters(), lr=0.5 * args.embed_learning_rate / width_multiplier, betas=(0.9, 0.95),
                               weight_decay=hidden_weight_decay, fused=True)
...
# begin logging
if master_process:
    run_id = 'train_gpt2_mupp_w384_lr0p0036_cosine_iwd0p1_' + str(uuid.uuid4())
