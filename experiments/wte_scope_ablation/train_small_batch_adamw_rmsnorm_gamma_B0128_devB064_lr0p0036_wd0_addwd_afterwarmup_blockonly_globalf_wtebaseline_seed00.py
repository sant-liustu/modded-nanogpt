...
# global-F controller while tied WTE keeps the reference optimizer policy.
...
# WTE remains WD=0 and follows its reference 2x WSD LR.
import os
import random
import sys
...
def maybe_apply_lrnorm_controller(update_step):
    ...
    # WTE is deliberately not part of the block-only controller. Reasserting
    # its reference policy makes this independent of scheduler bookkeeping.
    for group in optimizer1.param_groups:
        group['lr'] = reference_wte_lr
    ...
    if should_log_lrnorm_match(update_step):
        ...
        record = dict(
            control_arm='block_only_global_f_wte_baseline_policy',
            ...
            applied_wte_lr=reference_wte_lr,
            ...
            actual_wte_elr=reference_wte_lr / current_wte_rms,
            wte_lr_is_elr_matched=False,
