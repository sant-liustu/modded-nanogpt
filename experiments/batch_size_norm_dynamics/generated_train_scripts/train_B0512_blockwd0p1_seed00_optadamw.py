# Manual retained full-scale AdamW baseline experiment script.
# Copied from the AdEMAMix integration worktree; do not regenerate for this comparison set.
# Config: batch_size=512, block_weight_decay=0.1, lm_head_weight_decay=0.0, seed=0, device_batch_size=64, num_iterations=5100, optimizer2_type=adamw
