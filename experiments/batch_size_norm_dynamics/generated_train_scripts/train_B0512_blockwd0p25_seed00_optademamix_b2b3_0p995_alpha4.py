...
# Config: batch_size=512, block_weight_decay=0.25, lm_head_weight_decay=0.0, seed=0, device_batch_size=64, num_iterations=5100, optimizer2_type=ademamix, beta2=0.995, beta3=0.995, alpha=4
...
class Hyperparameters:
    ...
    weight_decay : float = 0.25 # transformer block weight decay; tied wte/lm_head is always excluded
    ...
    adema_alpha : float = 4.0 # AdEMAMix slow EMA mixing coefficient
