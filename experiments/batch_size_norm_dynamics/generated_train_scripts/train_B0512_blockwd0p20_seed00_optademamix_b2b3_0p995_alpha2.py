# Manual retained full-scale AdEMAMix experiment script.
# Copied from the AdEMAMix integration worktree; do not regenerate for this comparison set.
# Config: batch_size=512, block_weight_decay=0.20, lm_head_weight_decay=0.0, seed=0, device_batch_size=64, num_iterations=5100, optimizer2_type=ademamix, beta2=0.995, beta3=0.995, alpha=2
...
class Hyperparameters:
    ...
    weight_decay : float = 0.20 # transformer block weight decay; tied wte/lm_head is always excluded
    optimizer2_type : str = 'ademamix' # optimizer for transformer blocks: adamw or ademamix
    adema_beta1 : float = 0.9 # AdEMAMix fast EMA beta
    adema_beta2 : float = 0.995 # AdEMAMix second-moment beta
    adema_beta3 : float = 0.995 # AdEMAMix slow EMA beta
    adema_alpha : float = 2.0 # AdEMAMix slow EMA mixing coefficient
    ...
    adema_eps : float = 1e-08 # AdEMAMix denominator epsilon
    ...
    seed : int = 0 # RNG seed for generated experiment scripts
