...
# Purpose: weight-decay-0.1 variant of the 145M Qwen3-style AdamW run.
...
#         weight_decay=0.1 for tied embedding/head and block matrices,
#         RMSNorm gamma weight_decay=0.0, seed=0
import os
import random
import sys
...
from model_qwen3 import Qwen3Config, Qwen3ForCausalLM
