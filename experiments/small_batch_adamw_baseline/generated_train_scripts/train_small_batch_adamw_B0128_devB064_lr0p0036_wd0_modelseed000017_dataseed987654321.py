...
# Config: batch_size=128, device_batch_size=64, sequence_length=1024, num_iterations=20400, lr=0.0036, block_weight_decay=0.0, seed=17
import os
import random
import sys
...
class DistributedDataLoader:
    def __init__(
        ...
        if self.shuffle:
            data_rng = random.Random(self.data_seed)
            data_rng.shuffle(self.files)
