# Width-2560 all-AdamW learnable-gamma linear-down norm-control experiment.
# Delayed capture at step 750; RMS targets and block LR decrease together from 1.0x to 0.5x.
import os
import random
import sys
