# Qwen3-MoE 586M linear-up norm-control experiment.
# Capture tied embedding, block matrices, router matrices, and each expert matrix slice after warmup update 500, then linearly scale from 1x to 2x.
