...
# Architecture: noqknorm_rmsnorm; mode: matched; reference WD: 0.
...
class Hyperparameters:
    ...
    global_elr_reference_path : str = 'experiments/norm_control_schedule_collapse/reference_trajectories/noqknorm_rmsnorm_wd0p3_lr0p00045.jsonl'
