# Qwen3 linear-up norm-control experiment.
# Capture every unique 2D tensor RMS after update 1000, then linearly scale it from 1x to 2x.
# Match every controlled-matrix LR to the same schedule ratio; keep RMSNorm gamma on base WSD.
...
NORM_CONTROL_SCHEDULE = 'linear_up_1_to_2'
