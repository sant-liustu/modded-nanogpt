...
# Architecture: qknorm_rmsnorm; mode: matched; reference WD: 0.
...
GLOBAL_ELR_ARCHITECTURE = 'qknorm_rmsnorm'
...
class Hyperparameters:
    ...
    global_elr_reference_path : str = 'experiments/norm_control_schedule_collapse/reference_trajectories/qknorm_rmsnorm_wd0p3_lr0p00045.jsonl'
