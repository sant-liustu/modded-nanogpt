# Experiment 1A: Adam hard-norm stress-test arm with a single WSD RMS-ELR.
...
class Hyperparameters:
    ...
    seed : int = 0
    norm_control_config : str = 'experiments/norm_control_schedule_collapse/hardnorm_assignment_singleelr_A_seed20260901.json'
