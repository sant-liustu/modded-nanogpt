# Width-2560 all-AdamW learnable-gamma linear-up norm-control experiment.
# Delayed capture at step 750; RMS targets and block LR increase together from 1.0x to 2.0x.
import os
import random
import sys
