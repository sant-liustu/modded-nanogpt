# Qwen3-MoE 586M delayed-constant norm-control baseline.
# Capture tied embedding, block matrices, router matrices, and each expert matrix slice after warmup update 500, then project back to it.
