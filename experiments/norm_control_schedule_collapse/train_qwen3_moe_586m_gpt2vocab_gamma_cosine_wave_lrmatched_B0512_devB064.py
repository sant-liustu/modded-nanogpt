# Qwen3-MoE 586M cosine-wave norm-control experiment.
# Capture tied embedding, block matrices, router matrices, and each expert matrix slice after warmup update 500, then apply a 10000-step cosine wave with amplitude 0.5.
