# Qwen3 delayed-constant norm-control baseline.
# Capture every unique 2D tensor RMS after update 1000, then project back to it.
# Keep controlled-matrix and RMSNorm-gamma LRs on the base WSD schedule (s(t)=1).
...
NORM_CONTROL_SCHEDULE = 'constant'
