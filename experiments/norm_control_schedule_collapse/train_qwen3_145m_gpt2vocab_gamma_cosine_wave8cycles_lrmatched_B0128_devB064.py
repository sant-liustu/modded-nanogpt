# Qwen3 eight-cycle cosine-wave norm-control experiment.
# Capture every unique 2D tensor RMS after update 1000, then oscillate it over [0.5x, 1.5x].
# Match every controlled-matrix LR to the same period-2500 ratio; keep RMSNorm gamma on base WSD.
...
NORM_CONTROL_SCHEDULE = 'cosine_wave_period2500_amp0p5'
